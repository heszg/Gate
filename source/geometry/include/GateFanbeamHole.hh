...
#ifndef GateFanbeamHole_h
#define GateFanbeamHole_h 1
...
class GateCollimatorNavigation;

class GateFanbeamHole : public GateTrap {
public:
    GateFanbeamHole(const G4String& itsName, const G4String& itsMaterialName,
            G4double itsFocalDistanceX,  G4double itsSeptalThickness,
            G4double itsInnerRadius, G4double itsHeight, G4double itsDimensionX, G4double itsDimensionY);

    virtual ~GateFanbeamHole();
    ...
    void ResizeHole(G4double FocalDistanceX,  G4double SeptalThickness,
...
protected:
    ...
    GateCollimatorNavigation* m_navigation;
};
