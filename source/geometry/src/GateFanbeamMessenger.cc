...
GateFanbeamMessenger::GateFanbeamMessenger(GateFanbeam *itsInserter)
...
GateFanbeamMessenger::~GateFanbeamMessenger()
{
  delete dir_Geometry;
...
void GateFanbeamMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
